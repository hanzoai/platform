	...
	// =========================================================================
	{
		...
		inputSchema: {
			...
			properties: {
				...
				dockerImage: { type: "string", description: "Docker image (default: postgres:16)" },
			},
			required: ["name", "appName", "environmentId"],
		},
		handler: async (args) => {
	...
	// =========================================================================
	{
		...
		inputSchema: {
			...
			properties: {
				...
				dockerImage: { type: "string", description: "Docker image (default: mysql:8)" },
			},
			required: ["name", "appName", "environmentId"],
		},
		handler: async (args) => {
	...
	// =========================================================================
	{
		...
		inputSchema: {
			...
			properties: {
				...
				databasePassword: { type: "string", description: "Database password (auto-generated if empty)" },
				databaseRootPassword: { type: "string", description: "Root password (auto-generated if empty)" },
				dockerImage: { type: "string", description: "Docker image (default: mariadb:11)" },
			},
			required: ["name", "appName", "environmentId"],
		},
		handler: async (args) => {
	...
	// =========================================================================
	{
		...
		inputSchema: {
			...
			properties: {
				...
				databaseUser: { type: "string", description: "Database user" },
				databasePassword: { type: "string", description: "Database password (auto-generated if empty)" },
				dockerImage: { type: "string", description: "Docker image (default: mongo:7)" },
			},
			required: ["name", "appName", "environmentId"],
		},
		handler: async (args) => {
	...
	// =========================================================================
	{
		...
		inputSchema: {
			...
			properties: {
				...
				dockerImage: { type: "string", description: "Docker image (default: redis:7)" },
			},
			required: ["name", "appName", "environmentId"],
		},
		handler: async (args) => {
