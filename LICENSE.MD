...
- **Self-Hosted Version Free**: All features of Hanzo Platform, including multi-node support, Docker Compose file support, Preview Deployments and Multi Server, will always be free to use in the self-hosted version.
