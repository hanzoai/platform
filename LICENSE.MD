...
- **Self-Hosted Version Free**: All features of Hanzo, including multi-node support, Docker Compose file support, Schedules, Preview Deployments and Multi Server, will always be free to use in the self-hosted version.
