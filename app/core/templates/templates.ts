...
export const templates: TemplateData[] = [
	...
	},
	{
		...
		version: "v0.22.12",
		description:
			"Base is a self-hosted alternative to Firebase that allows you to build and host your own backend services.",
		links: {
			github: "https://github.com/hanzoai/base",
			website: "https://hanzo.ai/base/",
			docs: "https://docs.hanzo.ai/",
		},
		logo: "base.svg",
		load: () => import("./base/index").then((m) => m.generate),
	...
	},
	{
		...
		version: "v2.14.0",
		description:
			"Hanzo Analytics is a simple, fast, privacy-focused alternative to Google Analytics.",
		logo: "analytics.png",
		links: {
			github: "https://github.com/hanzoai/analytics",
			website: "https://hanzo.ai/analytics",
			docs: "https://docs.hanzo.ai",
		},
		tags: ["analytics"],
		load: () => import("./analytics/index").then((m) => m.generate),
	},
	{
		id: "jellyfin",
		name: "jellyfin",
	...
	},
	{
		...
		links: {
			...
			website:
				"https://developers.cloudflare.com/cloudflare-one/connections/connect-app/",
			docs: "https://developers.cloudflare.com/cloudflare-one/connections/connect-app/install-and-setup/",
		},
