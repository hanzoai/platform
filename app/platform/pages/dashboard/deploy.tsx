...
import { Checkbox, Tabs, TabsContent, TabsList, TabsTrigger } from "@hanzo/ui";
...
import { type ComposeSpec, ServiceSpec } from "@/lib/compose-spec";
...
const DeployPage = () => {
	...
	const [deployments, setDeployments] = useState<Map<string, string>>(
		new Map(),
	);
				...
				<TabsContent value="paste" className="mt-4">
					<Card>
						...
						<CardContent className="space-y-4">
							...
							/>
							<Button onClick={() => parseYaml(yamlContent)}>Parse YAML</Button>
						</CardContent>
					</Card>
				</TabsContent>
				...
				<>
					...
					<div className="flex justify-end gap-4">
						...
						>
							...
							Deploy {selectedServices.size} Service
