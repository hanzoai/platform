...
const DEFAULT_CSS_TEMPLATE = `/* ============================================
   Hanzo Platform Default Theme - CSS Variables
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Replaces "Hanzo Platform" across the entire interface.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											...
											the standard Hanzo Platform description if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Browser tab title. Defaults to "Hanzo Platform" if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
