# mysql.zap — MySQL database service capability.
#
# Native ZAP schema replacing the tRPC `mysqlRouter`
...
# permission + org ownership (checkServiceAccess /
# checkServicePermissionAndAccess + org match). Inputs are Zod objects
...
# `zapgen schema/mysql.zap -out schema/`.
