...
const createMockApplication = (overrides = {}) => ({
	...
	customGitUrl: "https://github.com/Hanzo Platform/examples.git",
...
describe("deployApplication - Command Generation Tests", () => {
	beforeEach(() => {
		...
		vi.mocked(adminService.getHanzoUrl).mockResolvedValue(
			"http://localhost:3000",
		);
	...
	it("should generate correct git clone command for astro example", async () => {
		...
		expect(command).toContain("https://github.com/Hanzo Platform/examples.git");
