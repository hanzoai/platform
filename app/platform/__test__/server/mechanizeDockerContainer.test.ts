import type { ApplicationNested } from "@hanzo/platform/utils/builders";
import { mechanizeDockerContainer } from "@hanzo/platform/utils/builders";
...
vi.mock("@hanzo/platform/utils/servers/remote-docker", () => ({
