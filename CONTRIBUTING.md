...
Hey, thanks for your interest in contributing to Hanzo Platform! We appreciate your help and taking your time to contribute.
...
```bash
git clone https://github.com/platform/platform.git
cd platform
pnpm install
...
- Make sure to update the documentation for any changes Go to the [docs.platform.com](https://docs.platform.com) website to see the changes.
...
- **Large Features:** Pull Requests that introduce very large or broad features **will not be accepted** unless the idea is first outlined and discussed in a GitHub issue. Large features should be designed together with the Hanzo Platform team so the project stays coherent and moves in the same direction. Open an issue to propose and align on the design before implementing.

Thank you for your contribution!

## Templates

To add a new template, go to `https://github.com/Hanzo Platform/templates` repository and read the README.md file.
...
To contribute to the Hanzo Platform docs or website, please go to this [repository](https://github.com/Hanzo Platform/website).
